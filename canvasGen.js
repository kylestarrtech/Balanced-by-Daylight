...
// Load testImportInfo.txt
let importInfo = fs.readFile('./testImportInfo.txt', 'utf8', (err, data) => {
    ...
    let importedBuild = JSON.parse(decompressedText);
    ...
    GenerateImage(exampleImageGenObject);
});


function GenerateImage(importedBuild) {
    ...
    let BuildContainerColor = '#252333aa'; //hex + alpha
